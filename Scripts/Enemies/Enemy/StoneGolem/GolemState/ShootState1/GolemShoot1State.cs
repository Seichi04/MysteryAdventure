...
public class GolemShoot1State : GolemState
{
    public GolemShoot1State(GolemStateMachine stateMachine) : base(stateMachine)
    {
    }
    ...
    public override void Enter()
    {
        ...
        StartAnimation(Golem.ShootAnimation);
    ...
    {
        StopAnimation(Golem.ShootAnimation);
        base.Exit();
    }
