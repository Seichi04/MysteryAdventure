...
public class GolemThorn2State : GolemState
{
    public GolemThorn2State(GolemStateMachine stateMachine) : base(stateMachine)
    {
    }
    ...
    public void CallThorn(int quantity)
    {
        ...
        {
            thorns[i].GetComponent<Thorn>().time = Golem.EnemySO.GolemData.TimeThorne2State;
